...
Global: `max_rounds` (default 10), `max_session_cost_usd`, `max_human_attempts`, `deviation_threshold` (0.4),
...
5. `human_input_node` — pause graph via `interrupt`, request missing info via stdin; on timeout write `state_dump.md`
   and exit
